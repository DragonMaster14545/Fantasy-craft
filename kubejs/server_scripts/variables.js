let testQuests = [
...

    {
        progress: 0, rewards: [{ type: 'story_quest_progress', value: 2 }], steps: [
            ...
            {
                task: {
                    type: 'deliver_items', amount: 5, progress: 0, inInventory: 0, itemId: 'minecraft:diamond', itemName: 'diamonds', id: 'npc1', name: 'Test npc1', dialogue: {
...

    {
        progress: 0, rewards: [{ type: 'side_quest_completed', value: 'test_quest' }], steps: [
            {
                task: {
                    type: 'talk_to_npc', amount: 1, progress: 0, id: 'npc1', name: 'Test npc2', dialogue: {
                        npcName: { text: 'Test npc', color: 0x00FFFF }, sentences: [
                            {
                                npc: [{ text: '1. sentence', color: 0xFFFFFF }, { text: 'line2', color: 0xFFFFFF }], answers: [
                                    { lines: [{ text: 'Close', color: 0xFFFFFF }, { text: 'line2', color: 0xFFFFFF }], result: 'close' }
...
let npcInteractions = {
    npc1: [{
        requirement: 'none', dialogue: {
            title: { text: 'Topic one', color: 0xFF00FF }, npcName: { text: 'Test npc', color: 0x00FFFF }, sentences: [
                {
...
let enemyStats = {
    damage:{ type: 'any', stat: 'damage', mode: '+'},
    armor:{ type: 'any', stat: 'armor', mode: '+'}
}
...
let levels = {
    universal: {
        mainQuestReqired: 0, costMultiplier: 1.2, name: { text: 'Universal', color: 0x45fc03 }, icon: 'minecraft:white_concrete', description: [{ text: 'A general level. Everything that gives you xp for other levels, also gives them for this', color: 0x45fc03 }], milestones: [
...
let testChatData = {
    npcName: { text: 'Random npc', color: 0x00FFFF }, sentences: [
        {
...
let cutscenes = {
    test1: {
        progress: 0, x: 0, y: 0, z: 0, dimension: 'fantasy_craft:void_dimension', steps: [
...
let classes = {
    main_timeline1: {
        //Warrior
        warrior: {
            x: 1, y: 0, requirements: [], cost: 1, icon: 'minecraft:red_concrete', iconOwned: 'minecraft:netherite_sword', name: { text: 'Warrior', color: 0xFF0000 }, description: [{ text: 'A class focused on mele weapons', color: 0x45fc03 }], skills: {
...
let debuffAreas = [
    //{x1:10,y1:0,z1:10,x2:-10,y2:10,z2:-10,dimension:'fantasy_craft:void_dimension1',particle:'minecraft:falling_spore_blossom',particleChance:0.05,type:'damage',cooldown:0,maxCooldown:20,damage:1,affects:'players'},
    //{x1:10,y1:0,z1:10,x2:-10,y2:10,z2:-10,dimension:'fantasy_craft:void_dimension1',particle:'minecraft:falling_spore_blossom',particleChance:0.05,type:'effects',cooldown:0,maxCooldown:20,effects:{ poison: {level: 1 } },affects:'players'},
    //{x1:10,y1:0,z1:10,x2:-10,y2:10,z2:-10,dimension:'fantasy_craft:void_dimension1',particle:'minecraft:falling_spore_blossom',particleChance:0.05,type:'noPlayerMagic',cooldown:0,maxCooldown:20,affects:'players'},
]


let enemySpawns = [
    //{type:'circle',x:0,y:0,z:0,radius:10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'test',color:0x509e31},damage:1,types:['air'],hpBars:3,spawnOnDeath:[{id:'minecraft:husk',maxHp:5,armor:0,name:Text.green('test spawn on death'),damage:1,types:['air']}],spawnOnDeathAmount:3,effectsOnHit:[{id:'minecraft:slowness',duration:100,level:1}],summons:[{id:'minecraft:husk',maxHp:4,armor:0,name:Text.green('test summon'),damage:1,types:['air']}],summonCooldown:100,summonAmount:2,selfHealAmount:20,selfHealCooldown:100,selfHealParticle:'minecraft:cloud',nearEntityGiveEffects:[{id:'minecraft:strength',duration:100,level:1}],nearEntityGiveEffectsType:'enemy',nearEntityGiveEffectsCooldown:100,nearEntityGiveEffectsDistance:3,nearEntityGiveEffectsParticle:'minecraft:soul_fire_flame'}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'test',color:0x509e31},damage:1,types:['air'],hpBars:3}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'test',color:0x509e31},damage:1,types:['air'],spawnOnDeath:[{id:'minecraft:husk',maxHp:5,armor:0,name:Text.green('test spawn on death'),damage:1,types:['air']}],spawnOnDeathAmount:3}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'test',color:0x509e31},damage:1,types:['air'],effectsOnHit:[{id:'minecraft:slowness',duration:100,level:1}]}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'test',color:0x509e31},damage:1,types:['air'],summons:[{id:'minecraft:husk',maxHp:4,armor:0,name:Text.green('test summon'),damage:1,types:['air']}],summonCooldown:100,summonAmount:2}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'test',color:0x509e31},damage:1,types:['air'],projectileCooldown:50,projectiles:[{speed:1,damage:5,effects:[{id:'minecraft:slowness',duration:80,level:1}],particle:'minecraft:crit'}]}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'test',color:0x509e31},damage:1,types:['air'],nearEnemyBoosts:[{id:'damage',amount:5,timer:200}],nearEnemyBoostsDistance:3,nearEnemyBoostsCooldown:100,nearEnemyBoostsParticle:'minecraft:soul_fire_flame'}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'test',color:0x509e31},damage:1,types:['air'],selfHealAmount:20,selfHealCooldown:100,selfHealParticle:'minecraft:cloud'}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'test',color:0x509e31},damage:1,types:['air'],nearEnemyHealAmount:20,nearEnemyHealCooldown:100,nearEnemyHealDistance:3,nearEnemyHealParticle:'minecraft:soul_fire_flame'}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'test',color:0x509e31},damage:1,types:['air'],selfGiveEffects:[{id:'minecraft:strength',duration:100,level:1}],selfGiveEffectsCooldown:100,selfGiveEffectsParticle:'minecraft:soul_fire_flame'}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'test',color:0x509e31},damage:1,types:['air'],nearEntityGiveEffects:[{id:'minecraft:strength',duration:100,level:1}],nearEntityGiveEffectsType:'enemy',nearEntityGiveEffectsCooldown:100,nearEntityGiveEffectsDistance:3,nearEntityGiveEffectsParticle:'minecraft:soul_fire_flame'}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'test',color:0x509e31},damage:1,types:['air'],nearEntityGiveEffects:[{id:'minecraft:wither',duration:100,level:1}],nearEntityGiveEffectsType:'player',nearEntityGiveEffectsCooldown:100,nearEntityGiveEffectsDistance:3,nearEntityGiveEffectsParticle:'minecraft:soul_fire_flame'}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'test',color:0x509e31},damage:1,types:['air'],trapCooldown:50,traps:[{duration:100,types:['fire'],onlyOwnerCanSee:true,activationRange:4.3,particle:'minecraft:crit',activations:2,damage:0,effects:{ poison: { duration: 100, level: 1 } },particle:'minecraft:crit'}]}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'Revivable test',color:0x509e31},damage:1,types:['air'],producesCorpse:true,corpseDuration:100,corpseParticle:'minecraft:flame',reviveParticle:'minecraft:soul_fire_flame'}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'test',color:0x509e31},damage:1,types:['air'],respawnDeadEnemiesCooldown:100,respawnDeadEnemiesAmount:2,respawnDeadEnemiesDistance:5}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'Absorbable effect test',color:0x509e31},damage:1,types:['air'],absorbable:true,absorbedBoosts:[{type:'effect',effects:[{id:'minecraft:regeneration',duration:100,level:1}]}],absorbedParticle:'minecraft:soul_fire_flame'}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'Absorbable heal test',color:0x509e31},damage:1,types:['air'],absorbable:true,absorbedBoosts:[{type:'heal',hp:10}],absorbedParticle:'minecraft:soul_fire_flame'}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'Absorbable boost test',color:0x509e31},damage:1,types:['air'],absorbable:true,absorbedBoosts:[{type:'boost',boosts:[{id:'damage',amount:5,timer:200}]}],absorbedParticle:'minecraft:soul_fire_flame'}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'test',color:0x509e31},damage:1,types:['air'],absorbEnemiesCooldown:100,absorbEnemiesAmount:2,absorbEnemiesDistance:5}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:2,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'test',color:0x509e31},damage:1,types:['air'],blockPlayerMagicDistance:3}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'test',color:0x509e31},damage:1,types:['air'],bossBarColor:'blue',bossBarDarkenScreen:false,bossBarCreateWorldFog:false,bossBarstyle:'progress',bossBarDistance:10}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'test',color:0x509e31},damage:1,types:['air'],hpBars:3,stages:[{requirementType:'hpBars',requirementAmount:2,rewards:[{type:'heal',amount:4}]}]}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'effects+ summon+ name test',color:0x509e31},damage:1,types:['air'],stages:[{requirementType:'hp',requirementAmount:10,rewards:[{type:'giveEffects',effects:[{id:'minecraft:wither',duration:100,level:1}]},{type:'summonEnemies',amount:2,enemies:[{id:'minecraft:husk',maxHp:5,armor:0,name:Text.green('test summon'),damage:1,types:['air']}]},{type:'changeName',name:{text:'Ultimate test',color:0xFF0000}}]}]}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'set data test',color:0x509e31},damage:1,types:['air'],stages:[{requirementType:'hp',requirementAmount:10,rewards:[{type:'setData',data:{blockPlayerMagicDistance:5}}]}]}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'remove data test',color:0x509e31},damage:1,types:['air'],blockPlayerMagicDistance:5,stages:[{requirementType:'hp',requirementAmount:10,rewards:[{type:'removeData',data:['blockPlayerMagicDistance']}]}]}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'set max hp test',color:0x509e31},damage:1,types:['air'],stages:[{requirementType:'hp',requirementAmount:10,rewards:[{type:'setMaxHp',amount:40}]}]}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'set max hp with heal test',color:0x509e31},damage:1,types:['air'],stages:[{requirementType:'hp',requirementAmount:10,rewards:[{type:'setMaxHpWithHeal',amount:40}]}]}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'set max hp with heal test',color:0x509e31},damage:1,types:['air'],bossBarColor:'blue',bossBarDarkenScreen:false,bossBarCreateWorldFog:false,bossBarstyle:'progress',bossBarDistance:10,stages:[{requirementType:'hp',requirementAmount:10,rewards:[{type:'changeName',name:{text:'Ultimate test',color:0xFF0000}}]}]}]},
    //{type:'rectangle',x1:10,y1:0,z1:10,x2:-10,y2:0,z2:-10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:200,entities:[{id:'minecraft:husk',maxHp:20,armor:0,name:{text:'normal husk',color:0x509e31},damage:1,types:['air'],bossBarColor:'blue',bossBarDarkenScreen:false,bossBarCreateWorldFog:false,bossBarstyle:'progress',bossBarDistance:15,stages:[{requirementType:'hp',requirementAmount:10,rewards:[{type:'changeName',name:{text:'Boss',color:0xFF0000}},{type:'setMaxHpWithHeal',amount:50},{type:'setData',data:{damage:10}},{type:'summonEnemies',amount:2,enemies:[{id:'minecraft:husk',maxHp:5,armor:0,name:Text.green('test summon'),damage:1,types:['air']}]}]},{requirementType:'hp',requirementAmount:20,stagesRequired:[0],rewards:[{type:'changeName',name:{text:'Real boss',color:0xFFFF00}},{type:'setMaxHpWithHeal',amount:500},{type:'setData',data:{maxProjectileCooldown:20,projectileCooldown:0,projectiles:[{speed:1,damage:5,effects:[{id:'minecraft:slowness',duration:80,level:1}],particle:'minecraft:flame'}]}}]}]}]},
]
