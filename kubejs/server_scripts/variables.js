...
let enemySpawns = [
    {type:'circle',x:0,y:0,z:0,radius:10,dimension:'fantasy_craft:void_dimension1',spawnRadius:20,maxEnemies:10,cooldown:0,maxCooldown:40,entities:[{id:'minecraft:zombie',maxHp:20,armor:0,name:Text.green('test'),damage:1,types:['air'],hpBars:3}]},
